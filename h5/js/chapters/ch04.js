  ...
  __chapters.push({
    ...
    sections: [
      ...
      { type: 'exercises', title: '练习', items: [
        { q: '三根 K 线（记为 (H, L)）：(110,100)、(108,105)、(115,112)，哪些存在包含关系？如何处理？', a: '第1根(110,100)与第2根(108,105)：110≥108 且 100≤105，第1根高点更高、低点更低，<b>第1根包含第2根</b>。第3根(115,112)与第2根(108,105)：115≥108 且 112≥105，第3根高点更高、低点也更高，<b>第3根包含第2根</b>。处理：先按合并方向（向上取高高、向下取低低）把相邻的包含K线合并。' },
