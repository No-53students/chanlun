...
<div class="cap">把情绪、贪嗔痴疑慢抛掉，回归<b>当下的走势</b>，用"买点买卖点卖"的节奏去等待被理论绝对保证的买卖点。</div></div>`;
  ...
  __chapters.push({
    id: 'ch49', vol: '卷十 · 心法与杂史', title: '第49章 心态纪律总纲', source: '原文第34、41、45、51、52、55、23、42、67课',
    figures: [
    ...
    sections: [
      ...
      { type: 'commentary', title: '解盘：坐轿子上华山（第67课）', text: '2007-08 的实盘解盘里，缠师用“坐轿子”讲透了一个朴素的仓位心法：先买够的人不增仓、不追高，只打差价降成本。', items: [
        { term: '① 坐轿子的三条策略', text: '第一拨人早在 3600 点就买够了，对后面抬轿子的人，缠师的策略三条：<b>①绝对不增仓</b>（现在还买是脑子水太多）；<b>②保持仓位、先卖后买打差价</b>，成本不断降低，永远立于不败之地；<b>③不听任何人忽悠冲多少</b>——<span class="hl">“我们的事情就是坐轿子……只要有人抬不动，就一定要一脚把轿子给踹了”</span>。', fig: mfig('坐轿子三原则', '<div style="font-size:12px;line-height:1.9;color:#1f2937">① 绝对不增仓<br>② 先卖后买打差价<br>③ 不追高，抬不动就踹轿子</div>', '低位买够，高位只打差价降成本') },
        { term: '② 不预测，只按策略应对', text: '对于“游戏第几关结束”，缠师的态度很干脆：<span class="hl">“预测都是无聊把戏，关键是有精密的操作。”</span>他把玩家分三类：<b>低手</b>看 5 日/5 周/5 月线持股不动；<b>大资金与中高手</b>一路涨一路降成本、持仓数量不变；<b>散户高手</b>利用板块轮动。做不到高手，就安心做低手。', fig: mfig('三类人的玩法', '<div style="font-size:12px;line-height:1.9;color:#1f2937">低手：5/5/5 线持股不动<br>中高手：降成本不减仓<br>高手：板块轮动</div>', '预测是无聊把戏，关键是精密操作') },
        { term: '③ 金句收束', text: '缠师这一课最值得记住的一句：<span class="hl">“股票都是废纸，一个好的策略与心态，能让你把废纸变黄金。”</span>', fig: mfig('废纸变黄金', '<div style="font-size:12px;line-height:1.9;color:#1f2937">股票 = <b>废纸</b><br><span style="color:#16a34a;font-weight:700">好策略 + 好心态 → 变黄金</span></div>', '策略与心态，把废纸变黄金') },
      ]},
    ],
  });
})();
