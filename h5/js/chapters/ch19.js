...
(function () {
  ...
  __chapters.push({
    id: 'ch19', vol: '卷五 · 分解与操作', title: '第19章 区间套', source: '原文第61、27、28课',
    figures: [
    ...
    sections: [
      ...
      { type: 'definition', title: '区间套的应用：三重背驰定大底', items: [
        { term: '① 大级别盘整背驰 + 区间套（第27课）', text: '判断<b>历史性底部</b>，要看<b>大级别</b>（<b>至少周线级别以上</b>；日线也可，但可靠性不绝对）的<b>盘整背驰</b>，再用区间套逐级缩小到小级别背驰，精确定位大底。级别越大、背驰越多重，底部信号越可靠。', fig: fig12f },
