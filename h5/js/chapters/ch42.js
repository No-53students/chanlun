...
<div class="cap">把每个板块内个股的<b>类别数平均</b>，得到<b>缠中说禅板块强弱指标</b>（越大越强）。最强的是<b>领涨板块</b>，各板块指标列在一起，<b>轮动的次序与节奏一目了然</b>：<span class="hl">领涨 → 跟涨 → 滞涨 → 补涨</span>，再配合个股走势分析，轮动操作就极为简单。</div></div>`;
  ...
  const figNine = mfig('8 条均线 → 9 类',
    ...
    '第2类 未攻克 13　第1类 未攻克 5<br>' +
    '<span style="color:#166534;font-weight:bold">最差：完全在所有均线之下</span></div>',
  ...
  const figStrong = mfig('最厉害的，不一定全在均线上',
    '<div style="font-size:12px;line-height:1.9;color:#1f2937">第 9 类（全在均线上）<b>不一定最厉害</b><br>——缠师留作思考：<br><span class="hl">均线附近蓄势调整的强股，可能更强</span><br><span style="color:#6b7280">分类只是监控辅助，最终回到走势本身</span></div>',
    '“不要所有答案都依赖本ID，思考一次比说 1000 次答案更好”');
  ...
  const figAux = mfig('均线系统回归为辅助监控工具',
    '<div style="font-size:12px;line-height:1.9;color:#1f2937">均线系统 = <b style="color:#2563eb">拐杖</b>（辅助监控）<br>用 8 条均线分类、看轮动强弱<br>但买卖点仍以<b>中枢、背驰</b>为准<br><span style="color:#6b7280">呼应第 25 课“中枢才是根本”</span></div>',
    '均线是辅助，不是根本');
  ...
  __chapters.push({
    ...
    sections: [
      { type: 'definition', title: '8 条均线对个股的分类（第106课）', items: [
        ...
        { term: '④ 最厉害的，不一定全在均线上', text: '第 9 类（全在均线上）<span class="hl">不一定最厉害</span>——这是缠师特意留的思考题：有些强股在均线附近<b>蓄势调整</b>，反而可能比已经远离均线的更强。<b>分类只是监控辅助，最终要回到走势本身。</b>', fig: figStrong },
      ]},
      { type: 'definition', title: '板块强弱指标与轮动（第106课）', items: [
        ...
        { term: '⑦ 均线系统回归为辅助监控工具', text: '均线系统在这里的定位是<b>辅助监控工具</b>：用 8 条均线做分类、看轮动强弱，但买卖点最终仍以<b>中枢、背驰</b>为准。<span class="hl">均线是“拐杖”，不是根本。</span>（与第 25 课“中枢才是根本”一脉相承。）', fig: figAux },
      ]},
      ...
      { type: 'exercises', title: '练习', items: [
        ...
        { q: '为什么说“最厉害的不一定完全在所有均线之上”？', a: '这是缠师留的思考题：<b>分类只是监控辅助</b>，均线附近蓄势调整的强股可能更强，不能把“站上全部均线”简单等同于最强，<b>最终要回到走势本身（中枢、背驰）</b>来判断。' },
      ]},
    ],
  });
})();
