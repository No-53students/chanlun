...
<div class="cap">第19课：缠论的<b>关键</b>是数学化、几何化、当下直观——不靠事后主观数浪，而是几何的严格定义。</div></div>`;
  ...
  __chapters.push({
    id: 'ch39', vol: '卷八 · 理论深化', title: '第39章 缠论的关键 + 递归补课', source: '原文第19、35课',
    figures: [
    ...
    sections: [
      ...
      { type: 'definition', title: '递归补课：中枢与走势类型的严格定义（第35课）', items: [
        ...
        { term: '⑤ 最低级别的定义（量子化起点）', text: '最低级别如量子力学的<b>量子</b>：物理世界不是无限连续的，市场交易也一样。最严格定义下，<b>每笔交易是最低级别</b>，连续三笔相同价位的交易就构成<b>最低级别的中枢</b>。有一个最低级别中枢的走势是最低级别盘整；有两个（第二个更高）就是最低级别上涨趋势。', formula: '连续三笔相同价位的交易 = 最低级别中枢', fig: figLowest },
