...
<div class="cap"><b style="color:#3730a3">↑ 自底向上</b>：形态学回答“走势长什么样”，动力学回答“力度够不够”，操作把两者变成“何时买、何时卖”。</div></div>`;
  ...
  const figFenjie = mfig('走势分解三定理',
    '<div style="font-size:12px;line-height:1.9;color:#1f2937">'
    + '<b>定理一</b>：唯一分解为同级别走势类型连接<br>'
    + '<b>定理二</b>：完成走势必含 ≥1 中枢<br>'
    + '<b>定理三</b>：高级别由低级别构成'
    + '</div>',
    '任何走势都可分解、都含中枢、都由低级别递归');
  ...
  __chapters.push({
    ...
    sections: [
      { type: 'definition', title: '核心定理速查', items: [
        ...
        { term: '② 走势分解定理（第62课）', fig: figFenjie, text: '定理一：任何走势都可唯一分解为同级别走势类型的连接；定理二：任何级别完成的走势类型，必然包含至少一个该级别中枢；定理三：高级别走势类型由低级别走势类型构成。', },
